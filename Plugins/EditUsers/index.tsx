...
import {SelectedGuildStore, GuildMemberStore} from "@webpack/common";
import {User} from "discord-types/general";
import {getUserData, loadData} from "./data_store";
...
const settings = definePluginSettings({
    activeNowList: {
        ...
        description: "Renders edited usernames in the active now list",
        default: true,
        restartNeeded: true
    },
    atMentions: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in @ mentions",
        default: true,
        restartNeeded: true
    },
    channelPermissions: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in channel permissions",
        default: true,
        restartNeeded: true
    },
    directMessagesList: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in direct messages list",
        default: true,
        restartNeeded: true
    },
    forumPostTitles: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in forum post titles",
        default: true,
        restartNeeded: true
    },
    inviteFriendModal: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in the invite friend modal",
        default: true,
        restartNeeded: true
    },
    memberLists: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in member lists",
        default: true,
        restartNeeded: true
    },
    mentionsList: {
        type: OptionType.BOOLEAN,
        description: "Allows you to search for edited usernames in mentions list",
        default: true,
        restartNeeded: true
    },
    mentionsLists: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in mentions lists",
        default: true,
        restartNeeded: true
    },
    messages: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in messages",
        default: true,
        restartNeeded: true
    },
    mutualFriendsLists: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in mutual friends lists",
        default: true,
        restartNeeded: true
    },
    reactionHover: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames on reaction hover",
        default: true,
        restartNeeded: true
    },
    reactionLists: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in reaction lists",
        default: true,
        restartNeeded: true
    },
    searchOptions: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in search options",
        default: true,
        restartNeeded: true
    },
    serverBoostMessages: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in server boost messages",
        default: true,
        restartNeeded: true
    },
    serverMembersList: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in server members list",
        default: true,
        restartNeeded: true
    },
    serverRoleSettings: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in server role settings",
        default: true,
        restartNeeded: true
    },
    streamMenu: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in stream menu",
        default: true,
        restartNeeded: true
    },
    threadBrowser: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in the thread browser",
        default: true,
        restartNeeded: true
    },
    threads: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in threads",
        default: true,
        restartNeeded: true
    },
    userInbox: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in user inbox",
        default: true,
        restartNeeded: true
    },
    userProfiles: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in user profiles",
        default: true,
        restartNeeded: true
    },
    voiceChatChannels: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in voice chat channels",
        default: true,
        restartNeeded: true
    },
    welcomeMessages: {
        type: OptionType.BOOLEAN,
        description: "Renders edited usernames in welcome messages",
        default: true,
        restartNeeded: true
    }
});

function UserContext(children: any, user: User)
{
...
export default definePlugin({
    ...
    patches: [
        ...
        // Renders edited usernames in stream menu
        {
            ...
            predicate: () => settings.store.streamMenu
        },
        // Renders edited usernames in user inbox
        {
            ...
            predicate: () => settings.store.userInbox
        },
        // Renders edited usernames in server members list
        {
            ...
            predicate: () => settings.store.serverMembersList
        },
        // Renders edited usernames in reaction lists
        {
            ...
            predicate: () => settings.store.reactionLists
        },
        // Renders edited usernames in the active now list
        {
            ...
            predicate: () => settings.store.activeNowList
        },
        // Renders edited usernames in the invite friend modal
        {
            ...
            predicate: () => settings.store.inviteFriendModal
        },
        // Renders edited usernames in threads
        {
            ...
            predicate: () => settings.store.threads
        },
        // Renders edited usernames in the thread browser
        {
            ...
            predicate: () => settings.store.threadBrowser
        },
        // Renders edited usernames in forum post titles
        {
            ...
            predicate: () => settings.store.forumPostTitles
        },
        // Renders edited usernames in welcome messages
        {
            ...
            all: true,
            noWarn: true,
            predicate: () => settings.store.welcomeMessages
        },
        // Renders edited usernames in direct messages list
        {
            ...
            predicate: () => settings.store.directMessagesList
        },
        // Renders edited usernames in server boost messages
        {
            ...
            predicate: () => settings.store.serverBoostMessages
        },
        // Renders edited usernames in messages
        {
            ...
            predicate: () => settings.store.messages
        },
        // Renders edited usernames in voice chat channels
        {
            ...
            predicate: () => settings.store.voiceChatChannels
        },
        // Renders edited usernames in mutual friends lists
        {
            ...
            predicate: () => settings.store.mutualFriendsLists
        },
        // Renders edited usernames in user profiles
        {
            ...
            predicate: () => settings.store.userProfiles
        },
        // Renders edited usernames in member lists
        {
            ...
            predicate: () => settings.store.memberLists
        },
        // Renders edited usernames in channel permissions
        {
            ...
            predicate: () => settings.store.channelPermissions
        },
        // Renders edited usernames in server role settings
        {
            ...
            predicate: () => settings.store.serverRoleSettings
        },
        // Renders edited usernames in @ mentions
        {
            ...
            predicate: () => settings.store.atMentions
        },
        // Renders edited usernames in mentions lists
        {
            ...
            predicate: () => settings.store.mentionsList
        },
        // Renders edited usernames in search options
        {
            ...
            predicate: () => settings.store.searchOptions
        },
        // Renders edited usernames on reaction hover
        {
            ...
            predicate: () => settings.store.reactionHover
        },
